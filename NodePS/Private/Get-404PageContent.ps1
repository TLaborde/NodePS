# NodePS Server 404 Module
function Get-404PageContent {
    param (
        [Parameter(
            Mandatory = $true)]
        $Hostname
...
<head>
<title>NodePS Server - 404.0 - Not Found</title>
<style type="text/css">
<!--
...
<div id="server_version"><p>NodePS Server Microsoft-HTTPAPI/2.0</p></div>
<div id="content">
